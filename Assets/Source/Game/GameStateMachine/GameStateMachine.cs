...
namespace Source
{
    public class GameStateMachine 
    {
        ...
        public GameStateMachine(SceneLoader sceneLoader, ProjectContext projectContext, IAssetsProvider assetsProvider)
        {
            _states = new Dictionary<Type, IExiteableState>
            {
                [typeof(BootstrapState)] = new BootstrapState(this, sceneLoader, assetsProvider, projectContext),
                [typeof(LoadGameState)] = new LoadGameState(this, sceneLoader, projectContext.GetSingle<IGameFactory>()),
            };
        }
